...
export default class Action extends React.Component {
  render() {
    ...
    let action_is_contactform = _.get(action, "is_contactform", null) || false;
    ...
    return (
      <>
        {action_is_contactform === true ? (
          <Contact text={_.get(action, "label", null)} />
        ) : (
          <Link
            ...
            className={classNames({
              button:
                action_style === "primary" || action_style === "secondary",
